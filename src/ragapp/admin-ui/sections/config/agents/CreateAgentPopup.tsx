...
export const CreateAgentPopup: React.FC<CreateAgentPopupProps> = ({ isOpen, onClose, onCreateAgent }) => {
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Create a new agent with the selected template or create an empty agent.
                    </DialogDescription>
                </DialogHeader>
                <div className="flex flex-col gap-4">
                    {agentTemplates.map((template) => (
                        <div key={template.name} className="p-4 border rounded-md flex justify-between items-center">
                            <div>
