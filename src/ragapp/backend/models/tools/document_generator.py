...
class DocumentGeneratorTool(BaseModel):
    ...
    custom_prompt: Optional[
        ...
        The output link of the generated file must start with '/api/files/output/tool/<file>'. It must be a relative path, don't try adding the domain name or protocol"""
    config: Dict = {}
    enabled: bool = False
