...
export interface ApiAssistantAssistant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    provinceId: Schema.Attribute.Relation<'oneToOne', 'api::province.province'>;
    serviceCategoryId: Schema.Attribute.Relation<
      'oneToOne',
      'api::service-category.service-category'
    >;
    containerIds: Schema.Attribute.Relation<'oneToMany', 'api::container.container'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::assistant.assistant'> &
      Schema.Attribute.Private;
  };
}
...
export interface ApiContainerContainer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    assistantType: Schema.Attribute.Enumeration<['OpenAI', 'Gemini']> &
      Schema.Attribute.Required;
    assistantId: Schema.Attribute.Relation<'manyToOne', 'api::assistant.assistant'>;
    metaData: Schema.Attribute.JSON;
    configured: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::container.container'> &
      Schema.Attribute.Private;
  };
}
...
export interface ApiRagFileRagFile extends Struct.CollectionTypeSchema {
  collectionName: 'rag_files';
  info: {
    singularName: 'rag-file';
    pluralName: 'rag-files';
    displayName: 'ragFiles';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    name: Schema.Attribute.String & Schema.Attribute.Required;
    url: Schema.Attribute.String & Schema.Attribute.Required;
    mimeType: Schema.Attribute.Enumeration<['pdf']> & Schema.Attribute.Required;
    size: Schema.Attribute.BigInteger;
    sourceType: Schema.Attribute.Enumeration<['rag', 'userUploaded']> &
      Schema.Attribute.Required;
    uploadedBy: Schema.Attribute.BigInteger;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::rag-file.rag-file'> &
      Schema.Attribute.Private;
  };
}

export interface ApiServiceCategoryServiceCategory extends Struct.CollectionTypeSchema {
  collectionName: 'service_categories';
  info: {
    singularName: 'service-category';
    pluralName: 'service-categories';
    displayName: 'serviceCategories';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::rag-file.rag-file': ApiRagFileRagFile;
