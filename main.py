...
app.include_router(
    tools_router, prefix="/api/management/tools", tags=["Agent"])
app.include_router(
    files_router, prefix="/api/management/files", tags=["Knowledge"])
app.include_router(llamacloud_router,
                   prefix="/api/management/llamacloud", tags=["Llamacloud"])
app.include_router(
